...
"""
    ...
    def test_prompt_enhancer_direct_vision_describe_modifier_guides_writer(self):
        ...
        self.assertIn("skin tone or visible complexion", writer_requests[0].prompt)
        self.assertIn("face shape", writer_requests[0].prompt)
        self.assertIn("facial structure", writer_requests[0].prompt)
        self.assertIn("facial features", writer_requests[0].prompt)
        self.assertIn("eye expression", writer_requests[0].prompt)
        self.assertIn("hair color and style", writer_requests[0].prompt)
        self.assertIn("apparent age range", writer_requests[0].prompt)
        self.assertIn("Do not infer ethnicity", writer_requests[0].prompt)
    ...
    def test_prompt_enhancer_separate_vision_describe_modifier_guides_vision_prompt(self):
        ...
        self.assertIn("skin tone or visible complexion", vision_requests[0].prompt)
        self.assertIn("face shape", vision_requests[0].prompt)
        self.assertIn("facial features", vision_requests[0].prompt)
        self.assertIn("hair color and style", vision_requests[0].prompt)
        self.assertIn("Do not infer ethnicity", vision_requests[0].prompt)
